...
const logger = new Logger('Flutter Eval API');
...
async function bootstrap() {
  ...
  app.enableCors({
    origin: true, // Permet tous les origins en développement
  ...
  await app.listen(PORT, () => logger.log(`🚀 FLUTTER EVAL API is running on: ${APP_URL}/${APP_ROUTE_PREFIX}`));
}
